...
feature_dim_ = int(256*4) 


checkpoint_file_input = r'.\Week11_Results\baseline_tests\checkpoint4.pt'
mp4_file_output = r'.\Week11_Results\baseline_tests\checkpoint4_vid_generalization.mp4'
evaluation_file = r'.\Week11_Results\baseline_tests\checkpoint4_evaluation_generalization.txt'
